 ...
 * @param {Model} instance - instance which have properties
 ...
 * @param {String} key
 * @param {undefined|null|Boolean|Number|String|Model|Array|Object} type
...
module.exports.get = (instance, key, type, options = {}) => {
    ...
    if (_typeof === 'function') {
        if (type.prototype instanceof Model) {
            ...
            return module.exports.get(instance, key, type(), options);
        }
    }
    ...
    if (_typeof === 'object' || type === Object) {
        ...
        const subname = `${instance.constructor.name}_${_.toPascalCase(key)}`;
    ...
    const single = (value, key, type) => {
        ...
        if (value instanceof Model) {
            ...
            switch (typeof populate) {
                case 'function':
                    return populate(value, key, type === SELF ? instance.constructor : type);
                case 'string': case 'boolean': default:
