...
module.exports = class Collection {
    constructor(property, value) {
        ...
        this.subfield = property.options.subfield;
                ...
                if (property === 'first') {
                    ...
                    return (entry) => {
                        this.property.set(target.filter((item) => {
                            if (this.subfield.kind === FIELD_KIND_MODEL) {
                    ...
                    return (callback) => {
                        const value = target[property]((id, index, array) => {
                            const subproperty = this.subfield.instantiate(this.property.instance, id, index);
                            const item = subproperty.get();
                    ...
                    if (target[property]) {
                        const subproperty = this.subfield.instantiate(this.property.instance, target[property], property);
                        const item = subproperty.get();
