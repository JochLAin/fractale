                ...
                if (property === 'first') {
                    ...
                    return (callback) => {
                        const value = target[property]((id, index, array) => {
                            const PropertyItem = this.item.instantiate(this.property.instance, id, index);
                    ...
                    if (target[property]) {
                        const PropertyItem = this.item.instantiate(this.property.instance, target[property], property);
                        const item = PropertyItem.get();
