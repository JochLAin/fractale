...
class ƒ_type {
    constructor(schema, key, generator, input, { validator, ...options } = {}) {
        ...
        try {
            if (input !== undefined && input !== null && input !== this.generator) {
    ...
    toJSON() {
        if (Object.keys(this.options).length) {
            return `Fractale.with(undefined, ${stringify(this.options)})`;
        }
        return 'undefined';
    }
}
...
module.exports.IncorrectValidatorTypeError = IncorrectValidatorTypeError;
