...
module.exports = class ƒ_array_biguint64 extends ƒ_type {
    constructor(schema, key, input, options) {
        super(schema, key, BigUint64Array, input, options);
    }

    static evaluate(input, type) {
        return type === 'object' && input instanceof BigUint64Array
            || type === 'function' && input === BigUint64Array
        ;
    }
    ...
    validate(value) {
        ...
        if (!(value instanceof this.generator) && typeof value[Symbol.iterator] !== 'function' && !(typeof value === 'string' && base64.test(value))) {
            throw this.createIncorrectTypeError('BigUint64Array || Iterable || base64 || undefined', value);
        }
    }
