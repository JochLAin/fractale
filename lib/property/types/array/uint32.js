...
module.exports = class ƒ_array_uint32 extends ƒ_type {
    constructor(schema, key, input, options) {
        super(schema, key, Uint32Array, input, options);
    }

    static evaluate(input, type) {
        return type === 'object' && input instanceof Uint32Array
            || type === 'function' && input === Uint32Array
        ;
    }
    ...
    validate(value) {
        ...
        if (!(value instanceof this.generator) && typeof value[Symbol.iterator] !== 'function' && !(typeof value === 'string' && base64.test(value))) {
            throw this.createIncorrectTypeError('Uint32Array || Iterable || base64 || undefined', value);
        }
    }
