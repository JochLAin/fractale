...
module.exports = class DateType extends MixedType {
    static normalize(field, next, previous) {
        if (!next) return undefined;
        return moment(next).format('YYYY-MM-DD[T]HH:mm:ss.SSS[Z]');
    }
    ...
    static validate(field, value) {
        if (value !== undefined && typeof value !== 'string' && !(value instanceof Date) && !moment.isMoment(value)) {
            throw DateType.createIncorrectTypeError('date || moment || string || undefined', value);
        }
