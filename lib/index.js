...
//     return () => {
//         const entity = module.exports.get(name);
 ...
 * @method
 * @param {undefined|Boolean|Number|String|Date|Model|Array|Object} kind - Property kind
 * @param {Object} options - Options pass to type
 */
module.exports.with = (kind, options) => {
    return { ƒ_kind: kind, ƒ_options: options };
};
