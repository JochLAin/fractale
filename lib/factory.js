...
module.exports.createModel = (name, parent, schema = {}, options = {}) => {
    ...
    if (!module.exports.validate(name)) {
            ...
            return new Proxy(entity, {
                ...
                get(target, property) {
                    if (typeof property === 'string' && entity.ƒ_properties.has(property)) {
                        ...
                        return entity.ƒ_properties.get(property).get(property);
                    }
                    return target[property];
                },
                set(target, property, value) {
                    if (typeof property === 'string' && entity.schema.has(property)) {
                        if (target[property]) {
                            throw new Error(`Property ${property} is defined in schema and class ${model.name}`);
                        }
                        entity.ƒ_properties.get(property).set(value, property);
                        return true;
                    }
