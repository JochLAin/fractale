    ...
    create(name, parent, schema, virtual = false) {
        ...
        const Entity = class extends Model {
            constructor(props = {}, overrider) {
                ...
                encyclopedia.provider.create(this.serialize(false));
                this.addEventListener('change', () => {
                    encyclopedia.provider.update(this.serialize(false));
                });

                return new Proxy(this, {
                    get(target, property) {
                        if (typeof property == 'string' && Object.keys(schema).includes(property) && !target[property]) {
