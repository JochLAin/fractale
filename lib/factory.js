        ...
        construct(target, args, newt) {
            ...
            return new Proxy(entity, {
                ...
                getOwnPropertyDescriptor(target, property) {
                    if (property in model.schema.values) {
                        return { value, enumerable: true, configurable: false };
                    }
                    if (property === 'constructor') {
                        return { value: target, enumerable: true, configurable: false };
                    }
                    if (property.indexOf('ƒ_') > -1) {
                        throw new Error(`Attempted to access to private member "${property}"`);
                    }
