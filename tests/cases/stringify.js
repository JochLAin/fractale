...
module.exports.resolver = (resolve) => {
    ...
    if (method !== `const Variable = Fractale.create("Variable", {"name":String,"value":mixed,"static":Boolean,"scope":{"__type":String,"__options":{"values":["private","protected","public"]}}});\n\nconst Method = Fractale.create("Method", {"signature":{"name":String,"properties":[Variable]},"body":String});`) {
        throw new Error('Error on metadata stringify method');
    }
