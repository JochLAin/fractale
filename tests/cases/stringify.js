...
module.exports.resolver = (resolve) => {
    ...
    if (compound !== `const Compound = Fractale.create("Compound", {"mixed":mixed,"boolean":Boolean,"number":Number,"string":String,"boards":[String],"metadata":{"key":String,"data":{"key":String,"value":mixed}},"collections":[{"key":String,"value":String}]});`) {
